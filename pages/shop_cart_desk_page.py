...
class ShopCartPageDesk(BasePage):
    ...
    def click_basket(self):
        basket_button = self.hover(L.button_basket_loc)
        basket_button.click()
    ...
    def is_second_product_displayed(self):
        return self.find(L.product_img_two_loc).is_displayed()
    ...
    def check_search_input_value(self, expected_text):
        actual_text = self.wait_for_element(L.search_input_loc).get_attribute("value")
        assert (
            actual_text == expected_text
